...
'This function takes in a numeric array and sorts it ascending.
'The function trims and splits the incoming array and trims and splits the outgoing array
FUNCTION sort_numeric_array_ascending_function(values_array, separate_character, sorted_values_array)
...
'This function sorts a numeric array descending
'The function trims and splits the incoming array and trims and splits the outgoing array
FUNCTION sort_numeric_array_descending_function(values_array, separate_character, sorted_values_array)
	'trimming and splitting the array	
	values_array = trim(values_array)
	values_array = split(values_array, separate_character)
	num_of_values = ubound(values_array)
